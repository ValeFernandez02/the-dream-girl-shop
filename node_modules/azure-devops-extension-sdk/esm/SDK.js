...
import { initializeNestedAppAuthBridge, teardownNestedAppAuthBridge } from './NestedAppAuthBridge.js';
 ...
 * ```
 */
async function enableNestedAppAuth() {
    await ready();
