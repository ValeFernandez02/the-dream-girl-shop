define(['exports', 'tslib', './XDM', './NestedAppAuthBridge'], (function (exports, tslib, XDM, NestedAppAuthBridge) { 'use strict';
    ...
    */
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, NestedAppAuthBridge.initializeNestedAppAuthBridge(parentChannel)];
                }
            });
        });
    }
     ...
     */
    function disableNestedAppAuth() {
        NestedAppAuthBridge.teardownNestedAppAuthBridge();
    }
    /**
    ...
    */
    ...
    exports.disableNestedAppAuth = disableNestedAppAuth;
    exports.enableNestedAppAuth = enableNestedAppAuth;
